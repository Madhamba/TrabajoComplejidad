...
from src.Entities.Drawable.DrawableBoard import DrawableBoard
from src.Entities.Drawable.DrawablePlayer import DrawablePlayer
    ...
    def start_interface(self, screen_size):
        ...
        for i in range(self.n_players):
            ...
            if self.n_players == 2:
                if player_number == 2:
                    player_number = 3
            player = DrawablePlayer(player_number, self.board, (randint(0, 255), randint(0, 255), randint(0, 255)))
            self.players.append(player)
